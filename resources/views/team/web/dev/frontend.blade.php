...
@section('content')
    ...
    <div class="max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800">
        <img class="object-cover object-center w-full h-56" src={{$front["cheminDunePhoto"]}} alt="avatar">
        ...
        <div class="px-6 py-4">
            <h1 class="text-xl font-semibold text-gray-800 dark:text-white">{{$front["nom"]}}</h1>

            <p class="py-2 text-gray-700 dark:text-gray-400">{{$front["fonction"]}}</p>
